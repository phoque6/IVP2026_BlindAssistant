#!/usr/bin/env python3
"""
Team Bravo Vision Assistant v8 — SLAM-style LiDAR view, sign OCR, 7s obstacle voice
==================================================================================

v8: Dense rainbow LiDAR point-cloud panel (SLAM look), any-sign OCR, obstacle voice every 7s.
...
Run:
    python3 team_bravo_aihat_camera_lidar_vision_assistant_v8_slam_lidar_sign_ocr.py
...
# OCR debug + voting (v8 sign-aware, any readable text)
ocr_debug_raw = ""
ocr_debug_cleaned = ""
ocr_debug_matched = ""
ocr_debug_confirmed = ""
